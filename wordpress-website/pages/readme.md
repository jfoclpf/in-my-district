This directory has the HTML code of the pages edited in wordpress. Since the wordpress pages are stored in a mysql database, updates must be done manually.
